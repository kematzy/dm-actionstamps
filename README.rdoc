...
This is a completely rewritten version of the rlivesey's dm-userstamp gem. 
...
and the <tt>"dm-userstamp"[http://github.com/rlivesey/dm-userstamp]</tt> gem was hardcoded to the <tt>User</tt> model.
...
As I said above, for a better understanding of this gem/plugin, make sure you study the '<tt>dm-actionstamps/spec/integration/actionstamps_spec.rb</tt>' file.
